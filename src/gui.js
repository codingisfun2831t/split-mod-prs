...
IDE_Morph.prototype.setDefaultTheme = function () {
  ...
  PushButtonMorph.prototype.outlineColor = new Color(225, 225, 225);
  PushButtonMorph.prototype.outlineGradient = false;
  PushButtonMorph.prototype.color = BLACK;
...
IDE_Morph.prototype.fixLayout = function (situation) {
  ...
  this.palette.setTop(this.controlBar.bottom() + padding + 44);
  ...
  if (situation !== "refreshPalette") {
    ...
    // oldSpriteBar
    this.oldSpriteBar.setLeft(this.left());
    this.oldSpriteBar.setTop(this.controlBar.bottom() + padding);
    ...
    if (this.spriteEditor.isVisible) {
      if (this.performerMode) {
        ...
        this.spriteEditor.setTop(this.oldSpriteBar.bottom() + padding);
...
IDE_Morph.prototype.applySavedSettings = function () {
  ...
  BlockMorph.prototype.isHighContrast = false;// this.getSetting("highContrast");
...
IDE_Morph.prototype.cloudMenu = function () {
  ...
  if (shiftClicked) {
    ...
    menu.addItem(
      ...
      null,
      this.hasChangedMedia ? new Color(255, 100, 100) : new Color(0, 100, 0),
    );
    menu.addItem(
...
IDE_Morph.prototype.toggleHighContrast = function () {
  var scripts = [];

  BlockMorph.prototype.isHighContrast = !BlockMorph.prototype.isHighContrast;
  this[BlockMorph.prototype.isHighContrast ? "saveSetting" : "removeSetting"]("highContrast");
  // select all scripts:
...
IDE_Morph.prototype.looksMenuData = function () {
  ...
  /*menu.addPreference(
    ...
    "toggleHighContrast",
    BlockMorph.prototype.isHighContrast,
...
ProjectDialogMorph.prototype.fixListFieldItemColors = function () {
  ...
  this.listField.contents.children[0].children.forEach((item) => {
    ...
    if (item.children[0]) {
      item.children[0].color = this.listField.color.b < 128 ? WHITE : BLACK;
    }
  });
};
...
LibraryImportDialogMorph.prototype.initializeLibraryDescription = function () {
  ...
  this.notesField.render = InputFieldMorph.prototype.render;
  this.notesField.drawRectBorder = InputFieldMorph.prototype.drawRectBorder;
  this.notesField.color = this.color;
...
LibraryImportDialogMorph.prototype.installLibrariesList = function () {
  ...
  this.listField.color = this.color;
  this.listField.bgColor = this.color;
...
TurtleIconMorph.prototype.userMenu = function () {
  ...
  menu.addItem(
    (this.object.penPoint === "tip" ? on : off) +
      " " +
      (isNamesMode ? "jens" : localize("tip")),
    () => {
  ...
  menu.addItem(
    (this.object.penPoint === "middle" ? on : off) +
      " " +
      (isNamesMode ? "brian" : localize("middle")),
    () => {
    ...
    this.editor.openIn(
      ...
      isNew
        ? isSvg
          ? new Point(240, 180)
          : null
        : this.sprite.costume.rotationCenter,
      costume
        ? (img, rc, shapes) => (
...
SoundIconMorph.prototype.createThumbnail = function () {
  ...
  this.button.setCenter(
    new Point(this.thumbSize.x / 2, this.thumbSize.y / 1.5),
  );
};
