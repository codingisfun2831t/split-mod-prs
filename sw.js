...
var version = '11.0.0',
    ...
    filesToCache = [
        ...
        // symbols
        'src/add-sprite.svg',
        "src/arrow-button-black.svg",
        "src/arrow-button.svg",
        "src/arrow-outline-black.svg",
        "src/arrow-outline.svg",
        "src/brush.svg",
        "src/brush-black.svg",
        "src/brush-grey.svg",
        ...
        "src/edit.svg",
        "src/eraser-black.svg",
        "src/eraser.svg",
        "src/extensions.svg",
        "src/extensions-black.svg",
        "src/file-black.svg",
        "src/file.svg",
        "src/flag.svg",
        "src/flag-red.svg",
        ...
        "src/notes-black.svg",
        "src/notes.svg",
        "src/paintbucket-black.svg",
        "src/paintbucket.svg",
        "src/pen-icon.svg",
        "src/pipette-black.svg",
        "src/pipette.svg",
        "src/repeat-black.svg",
        'src/repeat.svg',
        "src/rotate-left-black.svg",
        "src/rotate-left.svg",
        "src/rotate-right-black.svg",
        "src/rotate-right.svg",
        "src/select-black.svg",
        "src/select.svg",
        "src/settings-black.svg",
        "src/settings-grey.svg",
        "src/settings.svg",
        "src/shrink-black.svg",
        "src/shrink.svg",
        "src/shrink-grey.svg",
        "src/stop.svg",
        "src/trash-black.svg",
